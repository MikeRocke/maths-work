...
Given $\csc \theta = \frac{1}{\sin \theta}$ and $\cot \theta = \frac{1}{\tan \theta}$

Then we have

$\frac{\sin \theta + \tan \theta}{\csc \theta + \cot \theta} = (\sin \theta + \tan \theta) \cdot (\frac{1}{\frac{1}{\sin\theta} +\frac{1}{\tan \theta}}) = $
